...
// CONCATENATED MODULE: ./components/async-data.js
...
var async_data_default = /*#__PURE__*/function () {
  function _default() {
    _classCallCheck(this, _default);
  }
  ...
  _createClass(_default, null, [{
    key: "getData",
    value: function () {
      var _getData = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
        var res, data;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return external_isomorphic_fetch_default()('//jsonplaceholder.typicode.com/posts');
...
// CONCATENATED MODULE: ./pages/examples/async.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return async_default; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderPosts", function() { return async_RenderPosts; });


function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function async_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function async_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { async_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { async_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
function async_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function async_createClass(Constructor, protoProps, staticProps) { if (protoProps) async_defineProperties(Constructor.prototype, protoProps); if (staticProps) async_defineProperties(Constructor, staticProps); return Constructor; }
...
var async_default = /*#__PURE__*/function (_Page) {
  _inherits(_default, _Page);

  var _super = _createSuper(_default);

  async_createClass(_default, null, [{
    key: "getInitialProps",

    /* eslint no-undefined: "error" */
    value: function () {
      var _getInitialProps = async_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee(_ref) {
        var req, props;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.prev = 5;
                _context.next = 8;
                return async_data_default.getData();
  ...
  function _default(props) {
    ...
    async_classCallCheck(this, _default);
  ...
  async_createClass(_default, [{
    key: "componentDidMount",
    value: function () {
      var _componentDidMount = async_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/external_react_default.a.createElement(layout["a" /* default */], this.props, /*#__PURE__*/external_react_default.a.createElement("h1", {
        className: "display-2"
      }, "Async Data"), /*#__PURE__*/external_react_default.a.createElement("p", null, "This page is an example of how to fetch and load data asynchronously so that pages load quickly and with without blocking rendering when possible, but in a way that still works in browsers that do not support JavaScript."), /*#__PURE__*/external_react_default.a.createElement(external_reactstrap_["Row"], null, /*#__PURE__*/external_react_default.a.createElement(external_reactstrap_["Col"], {
        xs: "12",
        md: "6"
      }, /*#__PURE__*/external_react_default.a.createElement("h3", null, "Server Side Rendering"), /*#__PURE__*/external_react_default.a.createElement("p", null, "When rendering on the server, this page will not be rendered until it has fetched the remote data. This ensures web crawlers and browsers that do not have JavaScript enabled will still see the full content of the page.")), /*#__PURE__*/external_react_default.a.createElement(external_reactstrap_["Col"], {
        xs: "12",
        md: "6"
      }, /*#__PURE__*/external_react_default.a.createElement("h3", null, "Client Side Rendering"), /*#__PURE__*/external_react_default.a.createElement("p", null, "When the page is rendered by browser that supports JavaScript it will load the page immediately, without data, and have the client fetch and insert the data while the page is loading."))), /*#__PURE__*/external_react_default.a.createElement("p", null, "This page calls ", /*#__PURE__*/external_react_default.a.createElement("a", {
        href: "https://jsonplaceholder.typicode.com/"
      }, "jsonplaceholder.typicode.com"), " using ", /*#__PURE__*/external_react_default.a.createElement("a", {
        href: "https://github.com/matthew-andrews/isomorphic-fetch"
      }, "isomorphic-fetch"), "."), /*#__PURE__*/external_react_default.a.createElement("hr", null), /*#__PURE__*/external_react_default.a.createElement("h2", {
        className: "display-4"
      }, "Data from API"), /*#__PURE__*/external_react_default.a.createElement(async_RenderPosts, {
...
var async_RenderPosts = /*#__PURE__*/function (_React$Component) {
  _inherits(RenderPosts, _React$Component);

  var _super2 = _createSuper(RenderPosts);

  function RenderPosts() {
    async_classCallCheck(this, RenderPosts);

    return _super2.apply(this, arguments);
  }

  async_createClass(RenderPosts, [{
    key: "render",
    value: function render() {
      if (this.props.error) {
        ...
        return /*#__PURE__*/external_react_default.a.createElement("p", null, /*#__PURE__*/external_react_default.a.createElement("i", null, "Loading content\u2026"));
      } else {
        // Display posts
        return /*#__PURE__*/external_react_default.a.createElement(external_react_default.a.Fragment, null, this.props.posts.map(function (post, i) {
          return /*#__PURE__*/external_react_default.a.createElement("div", {
            key: i
          }, /*#__PURE__*/external_react_default.a.createElement("span", {
            className: "font-weight-bold"
          }, post.title), /*#__PURE__*/external_react_default.a.createElement("p", null, /*#__PURE__*/external_react_default.a.createElement("i", null, post.body)));
        }));
      }
    }
  }]);
