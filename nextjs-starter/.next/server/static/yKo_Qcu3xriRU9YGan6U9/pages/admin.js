...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return _default; });
/* harmony import */ var styled_jsx_style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
    ...
    value: function render() {
      if (this.props.fullscreen) {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a, {
          ...
          className: "jsx-2337374762" + " " + "circle-loader"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("svg", {
          width: "60",
          height: "60",
          version: "1.1",
          xmlns: "http://www.w3.org/2000/svg",
          className: "jsx-2337374762" + " " + "circle"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("circle", {
          cx: "30",
          cy: "30",
          r: "15",
          className: "jsx-2337374762"
        }))));
      }
    }
  }]);
...
var external_react_syntax_highlighter_ = __webpack_require__(13);

// EXTERNAL MODULE: external "react-syntax-highlighter/dist/styles/prism"
var prism_ = __webpack_require__(14);

// EXTERNAL MODULE: external "reactstrap"
var external_reactstrap_ = __webpack_require__(1);

// EXTERNAL MODULE: external "react-bootstrap-table"
var external_react_bootstrap_table_ = __webpack_require__(19);

// EXTERNAL MODULE: ./components/page.js
var components_page = __webpack_require__(12);
...
var user_default = /*#__PURE__*/function () {
  function _default() {
    _classCallCheck(this, _default);
  }
  ...
  _createClass(_default, null, [{
    key: "list",
    value: function () {
      var _list = _asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
        var _ref,
            _ref$page,
            page,
            _ref$size,
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, _ref$page = _ref.page, page = _ref$page === void 0 ? 0 : _ref$page, _ref$size = _ref.size, size = _ref$size === void 0 ? 10 : _ref$size;
                return _context.abrupt("return", external_isomorphic_fetch_default()("/admin/users?page=".concat(page, "&size=").concat(size), {
                  ...
                  return Promise.reject(Error('Error trying to list users'));
                }));
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return admin_default; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Table", function() { return admin_Table; });
...
var admin_default = /*#__PURE__*/function (_Page) {
  ...
  function _default(props) {
    ...
    admin_classCallCheck(this, _default);
    ...
    _this.options = {
      onPageChange: _this.onPageChange.bind(_assertThisInitialized(_this)),
      onSizePerPageList: _this.sizePerPageListChange.bind(_assertThisInitialized(_this)),
      page: 1,
      pageStartIndex: 1,
  ...
  admin_createClass(_default, [{
    key: "componentDidMount",
    value: function () {
      var _componentDidMount = admin_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    key: "onPageChange",
    value: function () {
      var _onPageChange = admin_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee2(page, sizePerPage) {
    ...
    key: "sizePerPageListChange",
    value: function () {
      var _sizePerPageListChange = admin_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee3(sizePerPage) {
      ...
      function sizePerPageListChange(_x3) {
        return _sizePerPageListChange.apply(this, arguments);
      }

      return sizePerPageListChange;
    }()
  }, {
    key: "updateData",
    value: function () {
      var _updateData = admin_asyncToGenerator( /*#__PURE__*/regenerator_default.a.mark(function _callee4() {
    ...
    key: "render",
    value: function render() {
      if (!this.props.session.user || this.props.session.user.admin !== true) return _get(_getPrototypeOf(_default.prototype), "adminAccessOnly", this).call(this);
      var data = this.state.data && this.state.data.users ? this.state.data.users : [];
      var totalSize = this.state.data && this.state.data.total ? this.state.data.total : 0;
      return /*#__PURE__*/external_react_default.a.createElement(layout["a" /* default */], _extends({}, this.props, {
        navmenu: false
      }), /*#__PURE__*/external_react_default.a.createElement("h1", {
        className: "display-4"
      }, "Administration"), /*#__PURE__*/external_react_default.a.createElement("p", {
        className: "lead text-muted "
      }, "This is an example read-only admin page which lists user accounts."), /*#__PURE__*/external_react_default.a.createElement(admin_Table, {
        data: data,
        totalSize: totalSize,
  ...
  return _default;
}(components_page["a" /* default */]);


var admin_Table = /*#__PURE__*/function (_React$Component) {
  _inherits(Table, _React$Component);

  var _super2 = _createSuper(Table);

  function Table() {
    admin_classCallCheck(this, Table);

    return _super2.apply(this, arguments);
  }

  admin_createClass(Table, [{
    key: "render",
    value: function render() {
      if (typeof window === 'undefined') return /*#__PURE__*/external_react_default.a.createElement("p", null, "This page requires JavaScript.");
      if (!this.props.data || this.props.data.length < 1) return /*#__PURE__*/external_react_default.a.createElement(loader["a" /* default */], null);
      var numberTo = this.props.options.page * this.props.options.sizePerPage < this.props.totalSize ? this.props.options.page * this.props.options.sizePerPage : this.props.totalSize;
      var numberFrom = numberTo - this.props.data.length + 1;
      return /*#__PURE__*/external_react_default.a.createElement(external_react_default.a.Fragment, null, /*#__PURE__*/external_react_default.a.createElement(external_react_bootstrap_table_["BootstrapTable"], {
        pagination: true,
        hover: true,
        bordered: false,
        remote: true,
      ...
      }, /*#__PURE__*/external_react_default.a.createElement(external_react_bootstrap_table_["TableHeaderColumn"], {
        isKey: true,
        dataField: "_id"
      }, "ID"), /*#__PURE__*/external_react_default.a.createElement(external_react_bootstrap_table_["TableHeaderColumn"], {
        dataField: "name"
      }, "Name"), /*#__PURE__*/external_react_default.a.createElement(external_react_bootstrap_table_["TableHeaderColumn"], {
        dataField: "email"
      }, "Email")), /*#__PURE__*/external_react_default.a.createElement("p", {
        className: "mt-2 text-muted text-right"
      }, "Displaying ", /*#__PURE__*/external_react_default.a.createElement("strong", null, numberFrom, "-", numberTo), " of ", /*#__PURE__*/external_react_default.a.createElement("strong", null, this.props.totalSize)));
    }
  }]);
